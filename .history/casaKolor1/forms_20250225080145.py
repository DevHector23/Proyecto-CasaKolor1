...
from .models import Sugerencia  # Asegúrate de importar el modelo

class SugerenciaForm(forms.ModelForm):  # Usa ModelForm para guardar en la BD
    class Meta:
        model = Sugerencia
        fields = ['nombre', 'correo', 'sugerencia']
        widgets = {
    ...
    def send_email(self):
        ...
        send_mail(
            asunto,
            mensaje,
            'hector3208609853@gmail.com',  # Cambia esto con tu correo
            ['hector3208609853@gmail.com'],  # Cambia esto con el destinatario
            fail_silently=False,
        )
