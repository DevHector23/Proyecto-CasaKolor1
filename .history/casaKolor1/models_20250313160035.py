...
class productos(models.Model):
    ...
    colores_disponibles = models.CharField(max_length=255, blank=True, null=True, help_text="Colores disponibles (solo para pinturas). Separa los colores con comas.")
