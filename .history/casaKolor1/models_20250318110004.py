...
class HistorialCompra(models.Model):
    ...
    pedido = models.ForeignKey(Pedido, on_delete=models.CASCADE, related_name='historial_pedidos')
    fecha_compra = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"Historial de {self.usuario.username} - Pedido #{self.pedido.id}"