document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('confirmarCompra').addEventListener('click', function () {
        ...
        // Generar un token único para evitar duplicados
        ...
        .then(data => {
            if (data.success) {
                ...
                notificacion.textContent = '¡Compra realizada con éxito! Redirigiendo...';
                document.body.appendChild(notificacion);
                
                // Breve retraso antes de redirigir (para que el usuario vea la notificación)
                setTimeout(() => {
                    notificacion.remove();
