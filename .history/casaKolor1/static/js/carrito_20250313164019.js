document.addEventListener('DOMContentLoaded', () => {
    ...
    if (confirmarCompraBtn) {
        confirmarCompraBtn.addEventListener('click', function () {
            ...
            console.log('Validando campos...'); // Depuración
            ...
            console.log('Deshabilitando botón y mostrando indicador de carga...'); // Depuración
            ...
            console.log('Enviando solicitud al servidor...'); // Depuración
            ...
            .then(response => {
                console.log('Respuesta del servidor recibida:', response); // Depuración
                if (!response.ok) {
