document.addEventListener('DOMContentLoaded', () => {
    ...
    if (confirmarCompraBtn) {
        confirmarCompraBtn.addEventListener('click', function () {
            ...
            // Aumentar el timeout para la solicitud fetch
            ...
            fetch('/finalizar-compra/', {
                ...
                // Asegurarse de que la solicitud se complete
                headers: {
            ...
            .then(data => {
                ...
                if (data.success) {
                    // Mostrar mensaje de éxito antes de realizar otras operaciones
                    ...
                    // Construir y mostrar mensaje de error
            ...
            .catch(error => {
                ...
                // Mostrar mensaje de error específico para timeout
                if (error.name === 'AbortError') {
                    alert('La solicitud ha tardado demasiado tiempo. Por favor, inténtelo de nuevo.');
                } else {
