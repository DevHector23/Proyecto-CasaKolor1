...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Activar panel de registro si hay modo register o si hay errores en el formulario de registro
    if (urlParams.get('mode') === 'register' || document.querySelector('.auth-signup-section .auth-error-container')) {
    ...
    function showError(input, message) {
        ...
        if (existingError && existingError.className === '