        ...
        if form.is_valid():
            try:
                with transaction.atomic():
                    ...
                    # Actualizar la caché para evitar procesamiento duplicado
                    cache.set(cache_key, True, 60 * 30)  # 30 minutos
                
                # IMPORTANTE: Mover la preparación y envío del correo fuera del bloque transaction.atomic
                ...
                try:
                    email = EmailMultiAlternatives(
                        ...
                        [pedido.correo, 'Hector3208609853@gmail.com']
                    )
                    ...
                    # El correo falló, pero el pedido ya está creado, así que continuamos
