...
def register_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            register_form = form
            # Añadir contexto para indicar que debe mostrar el panel de registro
            return render(request, 'login.html', {
                'form': login_form,
                'register_form': register_form,
                'mode': 'register'  # Este flag ayudará al template a saber que debe mostrar el panel de registro
            })
