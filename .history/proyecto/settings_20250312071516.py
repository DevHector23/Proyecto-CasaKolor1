...
EMAIL_HOST = env('EMAIL_HOST') # Servidor SMTP (Gmail como ejemplo)
EMAIL_PORT = env('EMAIL_PORT')
EMAIL_USE_TLS = env('EMAIL_USE_TLS')
EMAIL_HOST_USER =  env('EMAIL_HOTS_USER') # Tu correo
EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASS') # Contraseña o App Password si usas Gmail
