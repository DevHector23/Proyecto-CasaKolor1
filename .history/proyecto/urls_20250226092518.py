...
from casaKolor1.views import login_view, logout_view, clear_session_messages
...
urlpatterns = [
    ...
    path('clear-session-messages/', clear_session_messages, name='clear_session_messages'),
