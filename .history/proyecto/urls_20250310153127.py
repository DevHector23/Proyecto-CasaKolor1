...
from casaKolor1.views import login_view, clear_login_success,perfil,generar_factura_pdf
...
urlpatterns = [
    ...
    path('factura/<int:pedido_id>/', generar_factura_pdf, name='generar_factura_pdf'),
